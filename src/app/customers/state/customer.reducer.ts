...
export function customerResucer(state = initialState, action: customerActions.Action):CustomerState{
  switch (action.type) {
...
const getCustomersFeatureState = createFeatureSelector<CustomerState>(
  "customers"
)
